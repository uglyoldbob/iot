...
impl Ev1 {
    ...
    async fn manage_applications(
        ...
        match step {
            _ => {
                self.show_applications_list(admin, sget, html, appletid, userid, ca, s)
                    .await;
            }
        }
    }
    ...
    async fn run_applet(
        ...
        match action {
            ...
            Some("manage_applications") => {
                self.manage_applications(admin, sget, html, appletid, userid, ca, s)
                    .await;
            }
            _ => {
                html.body(|b| {
