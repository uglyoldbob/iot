...
lazy_static::lazy_static! {
    ...
    pub static ref OID_PKCS7_DATA_CONTENT_TYPE: yasna::models::ObjectIdentifier =
    ...
    pub static ref OID_SHROUDED_KEY_BAG: yasna::models::ObjectIdentifier =
        as_oid(&[1, 2, 840, 113_549, 1, 12, 10, 1, 2]);
    /// The oid for certificate bag
    pub static ref OID_CERT_BAG: yasna::models::ObjectIdentifier =
    ...
    /// The oid for sha1
    pub static ref OID_HASH_SHA1: yasna::models::ObjectIdentifier =
